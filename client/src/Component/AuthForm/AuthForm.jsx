...
const AuthForm = ({
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center gradien">
      <div className="bg-white rounded-2xl shadow-2xl p-1 w-full max-w-[1000px] h-[600px] mx-6">
        <div
          className="flex w-full h-full bg-primaryColor rounded-2xl transition-all duration-[900ms]"
          ref={bodyAuthForm}
        >
          <div className="left w-[60%] flex z-10 flex-col gap-8 justify-between transition-all duration-[900ms]">
          ...
          <div className="right bg-white w-full flex flex-col items-center transition-all py-10 justify-center duration-[900ms]">
            <div className="w-[60%]">
